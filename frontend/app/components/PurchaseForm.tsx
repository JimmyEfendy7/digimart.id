...
// Import tipe MidtransResult dari types.d.ts (global)
type MidtransResult = import('../../types').MidtransResult;
...
// (window.snap typings are declared globally in types.d.ts)
